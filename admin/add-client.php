...
$sql="insert into tblclient(AccountID,AccountType,ContactName,Address,Cellphnumber,Email,Notes,Password)values(:acctid,:accttype,:cname,:address,:cellphnumber,:email,:notes,:password)";
...
<html>
<head>
	<title>ZRP Roadside Management System|| Add Driver</title>
...
<h2 class="inner-tittle">Add Driver </h2>
