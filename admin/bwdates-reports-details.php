...
<html>
<head>
	<title>ZRP Roadside Management System || Between dates reports </title>
								...
								<table class="table" border="1"> <thead> <tr> <th>#</th> 
								    ...
								    <th>Contact Name</th> 
									 ...
									 <th>Action</th>
									    ...
									    <tbody>
									    	<?php
$sql="select distinct tblclient.ContactName,tblinvoice.BillingId,tblinvoice.PostingDate from  tblclient   
