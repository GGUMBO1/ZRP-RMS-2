...
$sql="update tblclient set AccountType=:accttype,Address=:address,Cellphnumber=:cellphnumber,Email=:email,Notes=:notes where ID=:eid";
...
<html>
<head>
	<title>ZRP Roadside Management System|| Update Clients</title>
